...
function LoadFunction()
	ImageButton.MouseEnter:Connect(function()
		(TweenService:Create(ImageButton, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.InOut), {
	...
	ImageButton.MouseButton1Down:Connect(function()
		if LoadFocus == false then
			...
			SoundClick2:Play();
			(TweenService:Create(ImageButton, TweenInfo.new(0.4, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
				ImageTransparency = 0
			})):Play();
			wait(0.5);
			(TweenService:Create(ImageButton, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.InOut), {
...
function dragify(Frame, object)
	...
	function updateInput(input)
		...
		if _G["ทำให้ UI ไม่ออก ขอบ"] then
			...
			(TweenService:Create(object, TweenInfo.new(dragSpeed), {
				Position = Position
			})):Play();
		else
...
function library.Create(options)
	...
	Shadown.BackgroundTransparency = 1;
	Shadown.Position = UDim2.new(0.5, 0, 0.5, 0);
	Shadown.Size = UDim2.new(0, options.UISize.X, 0, options.UISize.Y);
	...
	local function NNNF_fake_script()
		...
		delay(1, function()
			for i = 1, 10 do
				...
				((game:GetService("TweenService")):Create(script.Parent.LoadLogo, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					Rotation = 90 * i
				})):Play();
				if i >= 3 then
					((game:GetService("TweenService")):Create(script.Parent.LoadLogo, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						Position = UDim2.new(0.5, 0, 0.5, -30)
					})):Play();
					delay(1, function()
						((game:GetService("TweenService")):Create(script.Parent.TextLabel, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
							TextTransparency = 0
						})):Play();
						((game:GetService("TweenService")):Create(script.Parent.TextLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
							Position = UDim2.new(0.5, 0, 0.5, 30)
						})):Play();
						if i == 10 then
							OP = true;
		...
		task.delay(1, function()
			((game:GetService("TweenService")):Create(script.Parent, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
				Size = UDim2.new(0, 0, 0, 0)
			})):Play();
			((game:GetService("TweenService")):Create(script.Parent.TextLabel, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
				TextTransparency = 1
			})):Play();
			((game:GetService("TweenService")):Create(script.Parent.LoadLogo, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
				ImageTransparency = 1
			})):Play();
		end);
	end;
	...
	if DDX == nil then
		DDX = object.AbsolutePosition.X;
	end;
	if DDY == nil then
		DDY = object.AbsolutePosition.Y;
	end;
	...
	MainPage.BackgroundTransparency = 4;
	...
	library.TapGroup.CreateTap = function(options)
		...
		LeftMain.BackgroundTransparency = 1;
		LeftMain.BorderColor3 = Color3.fromRGB(0, 0, 0);
		LeftMain.BorderSizePixel = 0;
		LeftMain.Position = UDim2.new(0.0000000719754212, 0, 0, 0);
		...
		ButtonTap.MouseButton1Click:Connect(function()
			...
			for _, v in pairs(ScrollingFrame:GetChildren()) do
				if v:IsA("TextButton") then
					(TweenService:Create(v.TextLabel, TweenInfo.new(0.9, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
						TextColor3 = TapC
					})):Play();
					(TweenService:Create(v.ImageLabel, TweenInfo.new(0.9, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
						ImageColor3 = TapC
					})):Play();
				end;
			end;
			Page.Visible = true;
			(TweenService:Create(TextLabel, TweenInfo.new(0.9, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
				TextColor3 = Color3.fromRGB(255, 255, 255)
			})):Play();
			(TweenService:Create(ImageLabel, TweenInfo.new(0.9, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
		...
		library.Sections.CreatePage = function(options)
			...
			library.FuncMain.CreateLable = function(options)
				...
				Lable.BackgroundTransparency = 0.6;
			...
			library.FuncMain.CreateToggle = function(options, Lock)
				...
				if Dis ~= nil and Dis ~= "" then
					...
					TitleDis.BackgroundTransparency = 1;
				...
				if Dis == nil or Dis == "" then
					...
					TitleText.Position = UDim2.new(0.0441415198, 0, 0.5, 0);
				...
				ToggleO.BackgroundTransparency = 0.2;
				...
				if default == true then
					callback(default);
					(TweenService:Create(TitleText, TweenInfo.new(0.9, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
						TextColor3 = Color3.fromRGB(198, 200, 209)
					})):Play();
					(TweenService:Create(TitleDis, TweenInfo.new(0.9, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
						TextColor3 = Color3.fromRGB(198, 200, 209)
					})):Play();
					(TweenService:Create(O, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
						Position = UDim2.new(0.6, 0, 0.5, 0)
					})):Play();
					(TweenService:Create(O, TweenInfo.new(0.9, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
			...
			library.FuncMain.CreateButton = function(options)
				...
				TextButton_2.MouseButton1Click:Connect(function()
					...
					(TweenService:Create(TextLabel_3, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
						TextSize = 12
					})):Play();
					callback();
				end);
			...
			library.FuncMain.CreateDropdown = function(options)
				...
				Main1.BackgroundTransparency = 0.6;
				...
				Main2.BackgroundTransparency = 0.6;
				...
				function DropF:Add(Text)
					...
					if TextLabel_5.Text == default then
						for i, v in next, ScrollingFrame_2:GetChildren() do
							if v:IsA("Frame") then
								(TweenService:Create(v, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
									BackgroundColor3 = MainBackground or Color3.fromRGB(48, 51, 71)
								})):Play();
								(TweenService:Create(v.TextLabel, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
									TextColor3 = Color3.fromRGB(213, 213, 213)
								})):Play();
							end;
						end;
						(TweenService:Create(Button_2, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
							BackgroundColor3 = DropDownSelect or Color3.fromRGB(61, 65, 90)
						})):Play();
						(TweenService:Create(TextLabel_5, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
							TextColor3 = Color3.fromRGB(255, 255, 255)
						})):Play();
			...
			function library.FuncMain.CreateColorpicker(options)
				...
				Colorpicker.BackgroundTransparency = 0.6;
				...
				ColorpickerTitel.BackgroundTransparency = 1;
				...
				ColorSelection_2.BackgroundTransparency = 1;
				...
				UIGradient.Color = ColorSequence.new({
					...
					ColorSequenceKeypoint.new(0.19, Color3.fromRGB(255, 247, 0)),
					ColorSequenceKeypoint.new(0.38, Color3.fromRGB(34, 255, 0)),
					ColorSequenceKeypoint.new(0.56, Color3.fromRGB(0, 255, 247)),
					ColorSequenceKeypoint.new(0.74, Color3.fromRGB(0, 17, 255)),
					ColorSequenceKeypoint.new(0.89, Color3.fromRGB(238, 0, 255)),
			...
			function library.FuncMain.CreateSlider(options)
				local text = options.Name;
				wait();
				local callback = options.Format or function()
				end;
...
local Windown = library.Create({
	Title = "Domadic Hub| [discord.gg/H59rXDs5]",
	Logo = 12523036534,
	CornerRadius = 2,
	UISize = {
		X = 600,
...
function CheckBossQuest()
	...
	elseif _G.SelectBoss == "The Gorilla King" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(-1604.12012, 36.8521118, 154.23732, 0.0648873374, -0.00000470858913, -0.997892559, 0.000000141431883, 1, -0.00000470933674, 0.997892559, 0.000000164442184, 0.0648873374);
	...
	elseif _G.SelectBoss == "Bobby" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(-1139.59717, 4.75205183, 3825.16211, -0.959730506, -0.0000000075857054, 0.280922383, -0.0000000406310328, 1, -0.000000111807175, -0.280922383, -0.000000118718916, -0.959730506);
	...
	elseif _G.SelectBoss == "Yeti" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(1384.90247, 87.3078308, -1296.6825, 0.280209213, 0.0000000272035177, -0.959938943, -0.0000000675690828, 1, 0.0000000086151708, 0.959938943, 0.0000000624481444, 0.280209213);
	...
	elseif _G.SelectBoss == "Vice Admiral" then
		...
		LevelQuestBoss = 2;
		CFrameQuestBoss = CFrame.new(-5035.42285, 28.6520386, 4324.50293, -0.0611100644, -0.0000000808395768, 0.998130739, -0.0000000157416586, 1, 0.0000000800271849, -0.998130739, -0.0000000108217701, -0.0611100644);
	...
	elseif _G.SelectBoss == "Warden" then
		...
		LevelQuestBoss = 1;
		CFrameQuestBoss = CFrame.new(4851.35059, 5.68744135, 743.251282, -0.538484037, -0.0000000668303741, -0.842635691, 0.0000000138001752, 1, -0.0000000881300792, 0.842635691, -0.0000000590851599, -0.538484037);
	...
	elseif _G.SelectBoss == "Magma Admiral" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(-5317.07666, 12.2721891, 8517.41699, 0.51175487, -0.0000000265508806, -0.859131515, -0.0000000391131572, 1, -0.0000000542026761, 0.859131515, 0.0000000613418294, 0.51175487);
	...
	elseif _G.SelectBoss == "Fishman Lord" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(61123.0859, 18.5066795, 1570.18018, 0.927145958, 0.00000010624845, 0.374700129, -0.0000000698219367, 1, -0.000000110790765, -0.374700129, 0.0000000765569368, 0.927145958);
	...
	elseif _G.SelectBoss == "Wysper" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(-7862.94629, 5545.52832, -379.833954, 0.462944925, 0.0000000145838088, -0.886386991, 0.000000010534996, 1, 0.0000000219553424, 0.886386991, -0.0000000195022007, 0.462944925);
	...
	elseif _G.SelectBoss == "Thunder God" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(-7902.78613, 5635.99902, -1411.98706, -0.0361216255, -0.000000116895912, 0.999347389, 0.00000000144533963, 1, 0.000000117024491, -0.999347389, 0.0000000056715117, -0.0361216255);
	...
	elseif _G.SelectBoss == "Cyborg" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(5253.54834, 38.5361786, 4050.45166, -0.0112687312, -0.0000000993677887, -0.999936521, 0.000000000255291371, 1, -0.0000000993769547, 0.999936521, -0.00000000137512213, -0.0112687312);
	...
	elseif _G.SelectBoss == "Diamond" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(-424.080078, 73.0055847, 1836.91589, 0.253544956, -0.0000000142165932, 0.967323601, -0.0000000600147771, 1, 0.0000000304272909, -0.967323601, -0.000000065768397, 0.253544956);
	...
	elseif _G.SelectBoss == "Jeremy" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(632.698608, 73.1055908, 918.666321, -0.0319722369, 0.000000000896074881, -0.999488771, 0.000000000136326533, 1, 0.000000000892172336, 0.999488771, -0.000000000107732087, -0.0319722369);
	...
	elseif _G.SelectBoss == "Fajita" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(-2442.65015, 73.0511475, -3219.11523, -0.873540044, 0.000000042329841, -0.486752301, 0.0000000564383384, 1, -0.0000000143220786, 0.486752301, -0.0000000399823996, -0.873540044);
	...
	elseif _G.SelectBoss == "Smoke Admiral" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(-6059.96191, 15.9868021, -4904.7373, -0.444992423, -0.0000000030874483, 0.895534337, -0.0000000364098796, 1, -0.000000014644522, -0.895534337, -0.0000000391229982, -0.444992423);
	...
	elseif _G.SelectBoss == "Awakened Ice Admiral" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(5669.33203, 28.2118053, -6481.55908, 0.921275556, -0.0000000125320829, 0.388910472, 0.0000000472230788, 1, -0.0000000796414241, -0.388910472, 0.0000000917372489, 0.921275556);
	...
	elseif _G.SelectBoss == "Tide Keeper" then
		...
		LevelQuestBoss = 3;
		CFrameQuestBoss = CFrame.new(-3053.89648, 236.881363, -10148.2324, -0.985987961, -0.00000000358504737, 0.16681771, -0.00000000307832915, 1, 0.00000000329612559, -0.16681771, 0.00000000273641976, -0.985987961);
...
function topos(Pos)
	Distance = (Pos.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude;
	tween = ((game:GetService("TweenService")):Create((game:GetService("Players")).LocalPlayer.Character.HumanoidRootPart, TweenInfo.new(Distance / TweenSpeed, Enum.EasingStyle.Linear), {
		CFrame = Pos
	})):Play();
			...
			if _G.AutoDarkCoat and World2 then
				pcall(function()
					if (game:GetService("Workspace")).Enemies:FindFirstChild("Darkbeard") then
						...
						elseif _G.AutoDarkCoatHop then
							Hop();
						end;
					end;
				end);
	...
	function AddEsp(Name, Parent)
		...
		spawn(function()
			while wait() do
				pcall(function()
					wait(0.1);
					((game:GetService("TweenService")):Create(TextLabel, TweenInfo.new(1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
	...
	while task.wait() do
		pcall(function()
			if (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
				FM:Set("๐\159\140• Full Moon 100%");
			elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
				FM:Set("๐\159\140– Full Moon 75%");
			elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
				FM:Set("๐\159\140— Full Moon 50%");
			elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
				FM:Set("๐\159\140\152 Full Moon 25%");
			elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
				FM:Set("๐\159\140\152 Full Moon 15%");
			else
...
spawn(function()
	pcall(function()
		while wait() do
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
				MirageStatus:Set("๐\159\143\157๏ธ\143 Mirage Island is Spawning");
			else
				MirageStatus:Set("๐\159\143\157๏ธ\143 Mirage Island Not Spawn");
			end;
			if (game:GetService("Workspace")).Map:FindFirstChild("KitsuneIsland") then
				KitsuneStatus:Set("โ\155ฉ๏ธ\143 Kitsune Island is Spawning");
			else
				KitsuneStatus:Set("โ\155ฉ๏ธ\143 Kitsune Island Not Spawn");
			end;
			for i, v in pairs(game.Workspace:GetChildren()) do
				if string.find(v.Name, "Fruit") then
					FindFruit:Set("๐\159\141\143 Find " .. v.Name);
				else
					FindFruit:Set("๐\159\141\143 Nothing");
				end;
			end;
		end;
	end);
	...
	while wait(5) do
		pcall(function()
			if GetLegendarySwordDealer() then
				SwordDealer:Set("โ\154”๏ธ\143 Legendary Sword Dealer is Spawning");
			else
				SwordDealer:Set("โ\154”๏ธ\143 Legendary Sword Dealer Not Spawn");
			end;
			if (((game:GetService("ReplicatedStorage")):WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer("ColorsDealer", "1") then
				HakiDealer:Set("๐\159\159ข Haki Dealer is Spawning");
			else
				HakiDealer:Set("๐\159”ด Haki Dealer Not Spawn");
			end;
		end);
	end;
end);
